...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
        ...
        <div class="form_settings">
            ...
            <p><span>Disease Name</span><asp:TextBox CssClass="contact" ID="DiseaseName_TextBox" runat="server"></asp:TextBox></p>
            <p><span>Gene Name</span><asp:TextBox CssClass="contact" ID="GeneName_TextBox" runat="server"></asp:TextBox></p>
            <p><span>SNP</span><asp:TextBox CssClass="contact" ID="SNP_TextBox" runat="server"></asp:TextBox></p>
